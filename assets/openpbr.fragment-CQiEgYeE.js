...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=S);const Ge={name:o,shader:S},a="openpbrFragmentSamplersDeclaration",T=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=T);const xe={name:a,shader:T},t="openpbrNormalMapFragmentMainFunctions",A=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=A);const ye={name:t,shader:A},r="openpbrNormalMapFragmentFunctions",N=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=N);const ze={name:r,shader:N},n="openpbrConductorReflectance",b=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=b);const Ue={name:n,shader:b},s="openpbrAmbientOcclusionFunctions",L=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=L);const Xe={name:s,shader:L},c="openpbrVolumeFunctions",F=`struct OpenPBRHomogeneousVolume {vec3 extinction_coeff; 
vec3 ss_albedo; 
...
weight_sum.b<1e-5f ? unconvolved_irradiance.b : irradiance_sum.b/weight_sum.b);}`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=F);const We={name:c,shader:F},f="openpbrNormalMapFragment",D=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=D);const we={name:f,shader:D},l="openpbrBlockNormalFinal",O=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=O);const He={name:l,shader:O},_="openpbrBaseLayerData",C=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=C);const Be={name:_,shader:C},d="openpbrCoatLayerData",P=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=P);const Ve={name:d,shader:P},m="openpbrThinFilmLayerData",M=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=M);const ke={name:m,shader:M},u="openpbrFuzzLayerData",G=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=G);const Ye={name:u,shader:G},g="openpbrAmbientOcclusionData",x=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=x);const Ze={name:g,shader:x},E="openpbrBackgroundTransmission",y=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=y);const $e={name:E,shader:y},v="openpbrEnvironmentLighting",z=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=z);const je={name:v,shader:z},p="openpbrDirectLightingInit",U=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=U);const qe={name:p,shader:U},h="openpbrDirectLighting",X=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=X);const Ke={name:h,shader:X},R="openpbrBlockPrePass",W=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=W);const Qe={name:R,shader:W},I="openpbrPixelShader",w=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStore[I]||(e.ShadersStore[I]=w);const Je=[H,B,Le,V,Ge,k,Y,Me,Z,$,j,q,K,Q,xe,J,ee,ie,oe,ae,te,re,ne,se,ce,fe,le,_e,de,me,ue,ge,Ee,ve,ye,ze,pe,Fe,Ue,Xe,De,Oe,We,he,Re,we,He,Be,Ce,Pe,Ve,ke,Ye,Ze,Ie,$e,je,qe,Ke,Se,Te,Ae,Qe,Ne,be];for(const i of Je)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const ai={name:I,shader:w};export{ai as openpbrPixelShader};
