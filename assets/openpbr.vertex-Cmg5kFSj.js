import{S as e,d2 as _,d3 as s,d4 as N,d5 as l,aZ as A,b8 as I,au as d,av as c,ay as M,d6 as m,d7 as u,d8 as f,aw as p,ax as R,d9 as S,da as V,db as T,dc as x,dd as O,de as D,df as v,dg as G,az as F,aA as C,aB as L,dh as W,di as U,dj as g,aC as h,aD as Y,dk as P,aE as b,dl as X}from"./index-sBuscneu.js";import{o as y}from"./openpbrUboDeclaration-RyVPBBC3.js";const t="openpbrNormalMapVertexDeclaration",r=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=r);const B={name:t,shader:r},i="openpbrNormalMapVertex",E=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
var tbnNormal: vec3f=normalize(normalUpdated);var tbnTangent: vec3f=normalize(tangentUpdated.xyz);var tbnBitangent: vec3f=cross(tbnNormal,tbnTangent)*tangentUpdated.w;var matTemp= mat3x3f(finalWorld[0].xyz,finalWorld[1].xyz,finalWorld[2].xyz)* mat3x3f(tbnTangent,tbnBitangent,tbnNormal);vertexOutputs.vTBN0=matTemp[0];vertexOutputs.vTBN1=matTemp[1];vertexOutputs.vTBN2=matTemp[2];
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=E);const z={name:i,shader:E},a="openpbrVertexShader",o=`#define OPENPBR_VERTEX_SHADER
...
}`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=o);const H=[_,s,y,N,l,A,I,d,c,M,m,u,f,B,p,R,S,V,T,x,O,D,v,G,F,C,L,W,U,g,z,h,Y,P,b,X];for(const n of H)e.IncludesShadersStoreWGSL[n.name]||(e.IncludesShadersStoreWGSL[n.name]=n.shader);const Z={name:a,shader:o};export{Z as openpbrVertexShaderWGSL};
