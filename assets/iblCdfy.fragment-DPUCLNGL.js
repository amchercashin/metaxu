import{S as e,aY as c}from"./index-sBuscneu.js";const i="iblCdfyPixelShader",r=`precision highp sampler2D;precision highp samplerCube;
...
gl_FragColor=vec4(cdfy,0.0,0.0,1.0);}`;e.ShadersStore[i]||(e.ShadersStore[i]=r);const n=[c];for(const o of n)e.IncludesShadersStore[o.name]||(e.IncludesShadersStore[o.name]=o.shader);const a={name:i,shader:r};export{a as iblCdfyPixelShader};
