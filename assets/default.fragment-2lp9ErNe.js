import{t as e}from"./shaderStore-D-XQlhUT.js";import{d as t,f as ee,m as te,p as n,u as ne}from"./index-Bh6Qrd1z.js";import{i as r,n as re,r as ie,t as i}from"./fogFragment-NFgubt9V.js";import{n as ae,r as oe,t as a}from"./logDepthDeclaration-CQbRhlwH.js";var o=`prePassDeclaration`,s=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=s);var c={name:o,shader:s},l=`oitDeclaration`,u=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=u);var se={name:l,shader:u},d=`lightUboDeclaration`,f=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=f);var ce={name:d,shader:f},p=`ltcHelperFunctions`,m=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=m);var h={name:p,shader:m},g=`clusteredLightingFunctions`,_=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=_);var v={name:g,shader:_},y=`clusteredLightingCompute`,b=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var le={name:y,shader:b},x=`lightsFragmentFunctions`,S=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=S);var C={name:x,shader:S},w=`shadowsFragmentFunctions`,T=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=T);var ue={name:w,shader:T},E=`samplerFragmentDeclaration`,D=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=D);var de={name:E,shader:D},O=`reflectionFunction`,k=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=k);var fe={name:O,shader:k},A=`imageProcessingDeclaration`,j=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=j);var pe={name:A,shader:j},M=`imageProcessingFunctions`,N=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=N);var P={name:M,shader:N},F=`textureRepetitionFunctions`,I=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=I);var L={name:F,shader:I},R=`bumpFragmentMainFunctions`,z=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=z);var me={name:R,shader:z},B=`bumpFragmentFunctions`,V=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=V);var he={name:B,shader:V},H=`bumpFragment`,U=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=U);var ge={name:H,shader:U},W=`depthPrePass`,G=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=G);var _e={name:W,shader:G},K=`lightFragment`,q=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[K]||(e.IncludesShadersStoreWGSL[K]=q);var ve={name:K,shader:q},J=`logDepthFragment`,Y=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[J]||(e.IncludesShadersStoreWGSL[J]=Y);var ye={name:J,shader:Y},X=`oitFragment`,Z=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=Z);var be={name:X,shader:Z},Q=`defaultPixelShader`,$=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[Q]||(e.ShadersStoreWGSL[Q]=$);var xe=[t,ee,oe,c,se,ae,te,ce,h,v,le,C,ue,de,n,fe,pe,P,L,me,he,r,a,ie,re,ge,ne,_e,ve,ye,i,be];for(let t of xe)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var Se={name:Q,shader:$};export{Se as defaultPixelShaderWGSL};
//# sourceMappingURL=default.fragment-2lp9ErNe.js.map