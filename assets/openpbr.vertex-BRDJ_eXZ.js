import{S as e,cj as N,ck as l,cl as A,cm as I,cn as f,co as c,aY as m,bb as d,aJ as M,aK as u,aN as R,cp as S,cq as T,cr as p,aL as O,aM as D,cs as V,ct as v,cu as x,cv as C,cw as F,cx as h,cy as G,aO as g,aP as U,aQ as L,cz as Y,cA as P,cB as W,aR as b,aS as H,cC as y,aT as B,cD as X}from"./index-sBuscneu.js";import{o as z}from"./openpbrUboDeclaration-Bh9of6hr.js";const n="openpbrVertexDeclaration",t=`#include<sceneVertexDeclaration>
#ifdef BASE_COLOR
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=t);const Z={name:n,shader:t},o="openpbrNormalMapVertexDeclaration",E=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying mat3 vTBN;
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=E);const k={name:o,shader:E},a="openpbrNormalMapVertex",s=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
vec3 tbnNormal=normalize(normalUpdated);vec3 tbnTangent=normalize(tangentUpdated.xyz);vec3 tbnBitangent=cross(tbnNormal,tbnTangent)*tangentUpdated.w;vTBN=mat3(finalWorld)*mat3(tbnTangent,tbnBitangent,tbnNormal);
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=s);const w={name:a,shader:s},r="openpbrVertexShader",_=`#define OPENPBR_VERTEX_SHADER
...
`;e.ShadersStore[r]||(e.ShadersStore[r]=_);const K=[N,l,Z,A,I,z,f,c,m,d,M,u,R,S,T,p,k,O,D,V,v,x,C,F,h,G,g,U,L,Y,P,W,w,b,H,y,B,X];for(const i of K)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const Q={name:r,shader:_};export{Q as openpbrVertexShader};
