import{t as e}from"./shaderStore-D-XQlhUT.js";import{_ as t,d as ee,f as te,g as ne,h as re,m as n,v as ie}from"./index-Bh6Qrd1z.js";import{a as ae,i as oe,n as r,o as i,r as a,s as o,t as s}from"./vertexColorMixing-DxYrvkXY.js";import{n as c,r as se,t as ce}from"./logDepthDeclaration-CQbRhlwH.js";var l=`uvAttributeDeclaration`,u=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
...
`;e.ShadersStoreWGSL[Q]||(e.ShadersStoreWGSL[Q]=$);var be=[ee,te,se,le,n,o,ie,ne,ue,c,h,de,i,ae,b,fe,pe,me,ce,k,M,F,R,re,oe,t,V,he,ge,_e,a,r,ve,s,ye];for(let t of be)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var xe={name:Q,shader:$};export{xe as defaultVertexShaderWGSL};
//# sourceMappingURL=default.vertex-BWLSIgdr.js.map