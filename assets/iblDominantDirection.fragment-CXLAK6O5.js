import{S as e,aZ as n,b7 as t,b8 as c,b9 as S}from"./index-sBuscneu.js";const i="iblDominantDirectionPixelShader",a=`#include<helperFunctions>
...
lightDir/=vec3f(f32(NUM_SAMPLES));fragmentOutputs.color=vec4f(lightDir,1.0);}`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=a);const l=[n,t,c,S];for(const r of l)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const s={name:i,shader:a};export{s as iblDominantDirectionPixelShaderWGSL};
