import{S as e,aZ as c}from"./index-sBuscneu.js";const t="iblIcdfPixelShader",a=`#include<helperFunctions>
varying vUV: vec2f;
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=a);const i=[c];for(const r of i)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const n={name:t,shader:a};export{n as iblIcdfPixelShaderWGSL};
