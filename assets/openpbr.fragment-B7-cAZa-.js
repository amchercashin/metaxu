import{S as e,dm as w,dn as X,d2 as H,d3 as V,d5 as B,dp as k,dq as Y,dr as Z,ds as j,dt as $,aF as q,dc as K,aG as Q,du as J,aZ as ee,dv as re,b7 as ae,dw as te,dx as ie,dy as ne,d8 as oe,dz as fe,dA as se,dB as le,b8 as ce,b9 as _e,dC as me,dD as de,dE as ue,dF as pe,dG as ge,dH as ve,aH as Ee,dI as Se,dJ as he,dK as Ie,aI as Re,dL as be,dM as Ne,dN as Te}from"./index-sjUA0Uw-.js";import{o as Ae}from"./openpbrUboDeclaration-CrAm42aB.js";import{o as Le,a as Fe,b as De,c as Oe,d as Ce}from"./openpbrTransmissionLayerData-CU01NEI6.js";const a="openpbrFragmentSamplersDeclaration",I=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=I);const Pe={name:a,shader:I},t="openpbrNormalMapFragmentMainFunctions",R=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=R);const Ge={name:t,shader:R},i="openpbrNormalMapFragmentFunctions",b=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=b);const xe={name:i,shader:b},n="openpbrConductorReflectance",N=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=N);const Me={name:n,shader:N},o="openpbrAmbientOcclusionFunctions",T=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=T);const ye={name:o,shader:T},f="openpbrVolumeFunctions",A=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=A);const We={name:f,shader:A},s="openpbrNormalMapFragment",L=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=L);const ze={name:s,shader:L},l="openpbrBlockNormalFinal",F=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=F);const Ue={name:l,shader:F},c="openpbrBaseLayerData",D=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=D);const we={name:c,shader:D},_="openpbrCoatLayerData",O=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=O);const Xe={name:_,shader:O},m="openpbrThinFilmLayerData",C=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=C);const He={name:m,shader:C},d="openpbrFuzzLayerData",P=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=P);const Ve={name:d,shader:P},u="openpbrAmbientOcclusionData",G=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=G);const Be={name:u,shader:G},p="openpbrBackgroundTransmission",x=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=x);const ke={name:p,shader:x},g="openpbrEnvironmentLighting",M=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=M);const Ye={name:g,shader:M},v="openpbrDirectLightingInit",y=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=y);const Ze={name:v,shader:y},E="openpbrDirectLighting",W=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=W);const je={name:E,shader:W},S="openpbrBlockPrePass",z=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=z);const $e={name:S,shader:z},h="openpbrPixelShader",U=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[h]||(e.ShadersStoreWGSL[h]=U);const qe=[w,X,H,V,Ae,B,k,Y,Z,j,Pe,$,q,K,Q,J,ee,re,ae,te,ie,ne,oe,fe,se,le,ce,_e,me,de,ue,pe,ge,Ge,xe,ve,Le,Me,ye,Fe,De,We,Ee,Se,ze,Ue,we,Oe,Ce,Xe,He,Ve,Be,he,ke,Ye,Ze,je,Ie,Re,be,$e,Ne,Te];for(const r of qe)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const er={name:h,shader:U};export{er as openpbrPixelShaderWGSL};
