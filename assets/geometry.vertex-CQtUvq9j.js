import{S as e,au as n,av as f,da as a,db as v,ay as o,d2 as s,aw as d,d8 as u,df as c,dg as l,az as m,aA as p,aB as x,aC as U,dO as E}from"./index-sBuscneu.js";const r="geometryVertexShader",t=`#include<bonesDeclaration>
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=t);const I=[n,f,a,v,o,s,d,u,c,l,m,p,x,U,E];for(const i of I)e.IncludesShadersStoreWGSL[i.name]||(e.IncludesShadersStoreWGSL[i.name]=i.shader);const S={name:r,shader:t};export{S as geometryVertexShaderWGSL};
