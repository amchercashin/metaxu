import{S as e,aU as o,dT as t,cK as d,dU as l,aY as c,cL as s,cl as E,bb as v,cW as m,cX as u,aW as S,dV as I}from"./index-sjUA0Uw-.js";import{s as R,o as T,a as A,b as p,d as D,c as _}from"./openpbrTransmissionLayerData-CtDJf5vi.js";const n="mrtFragmentDeclaration",a=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
layout(location=0) out vec4 glFragData[{X}];
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=a);const g={name:n,shader:a},r="geometryPixelShader",f=`#extension GL_EXT_draw_buffers : require
...
`;e.ShadersStore[r]||(e.ShadersStore[r]=f);const L=[o,g,t,d,l,c,s,R,E,v,T,m,u,A,p,S,I,D,_];for(const i of L)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const C={name:r,shader:f};export{C as geometryPixelShader};
