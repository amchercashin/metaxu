import{S as e}from"./index-sBuscneu.js";const n="sceneFragmentDeclaration",c=`uniform mat4 viewProjection;
#ifdef MULTIVIEW
uniform mat4 viewProjectionR;
#endif
uniform mat4 view;uniform mat4 projection;uniform vec4 vEyePosition;uniform mat4 inverseProjection;
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=c);const u={name:n,shader:c},i="openpbrDielectricReflectance",s=`struct ReflectanceParams
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=s);const I={name:i,shader:s},r="openpbrGeometryInfo",f=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=f);const v={name:r,shader:f},o="openpbrIblFunctions",l=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=m);const p={name:t,shader:m};export{v as a,E as b,p as c,S as d,I as o,u as s};
