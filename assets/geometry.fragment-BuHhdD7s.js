import{S as e,aF as n,dP as f,dr as t,dQ as o,aZ as s,ds as l,d2 as d,b8 as c,dG as v,dH as u,aH as m,dR as S}from"./index-sBuscneu.js";import{o as E,a as p,b as R,d as T,c as I}from"./openpbrTransmissionLayerData-Lhmcj7XO.js";const r="geometryPixelShader",a=`#ifdef BUMP
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=a);const A=[n,f,t,o,s,l,d,c,E,v,u,p,R,m,S,T,I];for(const i of A)e.IncludesShadersStoreWGSL[i.name]||(e.IncludesShadersStoreWGSL[i.name]=i.shader);const N={name:r,shader:a};export{N as geometryPixelShaderWGSL};
