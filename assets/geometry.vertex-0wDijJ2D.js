import{S as e,aJ as f,aK as c,cu as v,cv as s,aN as l,cl as u,aL as m,cr as U,cx as E,cy as p,aO as V,aP as S,aQ as I,aR as h,dS as N}from"./index-sjUA0Uw-.js";const n="geometryVertexDeclaration",t="uniform mat4 viewProjection;uniform mat4 view;";e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=t);const x={name:n,shader:t},r="geometryUboDeclaration",o=`#include<sceneUboDeclaration>
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=o);const P={name:r,shader:o},a="geometryVertexShader",d=`precision highp float;
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=d);const _=[f,c,v,s,l,x,u,P,m,U,E,p,V,S,I,h,N];for(const i of _)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const R={name:a,shader:d};export{R as geometryVertexShader};
