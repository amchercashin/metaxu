import{S as e,aY as c}from"./index-sBuscneu.js";const i="iblIcdfPixelShader",o=`precision highp sampler2D;
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=o);const r=[c];for(const t of r)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);const l={name:i,shader:o};export{l as iblIcdfPixelShader};
